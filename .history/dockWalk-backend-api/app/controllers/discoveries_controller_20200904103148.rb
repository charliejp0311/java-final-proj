class DiscoveriesController < ApplicationController
  ...
  def create
    ...
    if prams[:s_comments]
      discovery = Discovery.create(dock_id: dock.id, door_range_id: range.id, door_id: door.id, serviceable: params[:serviceable], service_comments: params[:s_comments])
      door.update(serviceable: params[:serviceable], service_comments: params[:s_comments])
