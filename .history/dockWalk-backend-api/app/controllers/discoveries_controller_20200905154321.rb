class DiscoveriesController < ApplicationController
  ...
  def create
    ...
    if discovery.serviceable
      door.update(racks: params[:racks], stage: params[:stage], inbound_present: params[:inbound_present], inbound_available: params[:inbound_available], outbound_present: params[:outbound_present], outbound_available: params[:outbound_available], serviceable: params[:serviceable], service_comments: '')
    else
      door.update(racks: params[:racks], stage: params[:stage], inbound_present: params[:inbound_present], inbound_available: params[:inbound_available], outbound_present: params[:outbound_present], outbound_available: params[:outbound_available], serviceable: params[:serviceable], service_comments: params[:s_comments])
    end
